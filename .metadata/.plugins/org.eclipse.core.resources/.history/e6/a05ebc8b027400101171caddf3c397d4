...
public class Register {
	...
	private RegisterPage register_page = null;
	...
	private void register(ExtentTest test, String usr, String pass) {
		...
		register_page.completeUsr(usr);
		usr_actual = register_page.getUsrFldContent();
		
		register_page.completePass(pass);
		pass_actual = register_page.getPassFldContent();
		
		register_page.clickRegisterBtn2();
		
		alert_txt_actual = register_page.getAlertTextString();
		register_page.acceptAlert();
